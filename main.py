...
precios = tuple((
    ...
    4200, 
    4800))
print("Menu de selecion de productos")
...
print(f"Usuario usted seleciono el producto {productos[opcion]} con un valor de ${precios[opcion]}")
...
if dinero >= precios[opcion]:
    ...
    print(f"Usuario el producto que desea comprara {productos[opcion]} con un valor de ${precios[opcion]}, le falta un total de ${-vueltos} ")
